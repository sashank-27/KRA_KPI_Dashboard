                ...
                {selectedUser === "all" ? (
                  kpiData.map((user) => (
                    <TableRow key={user.userId}>
                      ...
                      <TableCell>{user.open}</TableCell>
                      <TableCell>{user.pending}</TableCell>
                      <TableCell>{user.escalated}</TableCell>
                      <TableCell>
                        <Badge className={getPerformanceBadge(user.completionRate)}>
                          {user.completionRate.toFixed(2)}%
                        </Badge>
                      </TableCell>
                      <TableCell>
                        <Badge className={getPerformanceBadge(user.penalizedRate)}>
                          {user.penalizedRate.toFixed(2)}%
                        </Badge>
                      </TableCell>
                    </TableRow>
                  ))
                  ...
                  <TableRow>
                    ...
                    <TableCell>{userKpiData.open}</TableCell>
                    <TableCell>{userKpiData.pending}</TableCell>
                    <TableCell>{userKpiData.escalated}</TableCell>
                    <TableCell>
                      <Badge className={getPerformanceBadge(parseFloat(userKpiData.completionRate))}>
                        {userKpiData.completionRate}%
                      </Badge>
                    ...
                    <TableCell>
                      <Badge className={getPerformanceBadge(parseFloat(userKpiData.penalizedRate))}>
                        {userKpiData.penalizedRate}%
                      </Badge>
                    </TableCell>
                  </TableRow>
